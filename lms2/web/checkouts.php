                                ...
                                <div class="entry-content">
                                    ...
                                    <div id="order_review" class="woocommerce-checkout-review-order">
                                        ...
                                        <table class="shop_table woocommerce-checkout-review-order-table">
                                            ...
                                            <tbody id="cart-details"> <!-- This is where cart details will be inserted dynamically -->
                                            </tbody>
                                            <tfoot>
                                                <tr class="cart-subtotal">
                                                    <th>Subtotal</th>
                                                    <td><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">₹</span><span id="cart-subtotal">0.00</span></span></td>
                                                </tr>
                                                <tr class="order-total">
                                                    <th>Total</th>
                                                    <td><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">₹</span><span id="cart-total">0.00</span></span></strong></td>
                                                </tr>
                                            </tfoot>
                                        </table>
