...
<head>
   ...
   <!-- / <link rel="stylesheet" href="home/assets/css/dashlite.css?ver=3.2.3"> -->
   <link rel="stylesheet" href="home/assets/css/dashlite.css?ver=3.2.3">
    <!-- <link rel="stylesheet" href="home/assets/css/dashlite.css"> -->
    <link id="skin-default" rel="stylesheet" href="home/assets/css/theme.css?ver=3.2.3">
            ...
            <div class="nk-sidebar nk-sidebar-fixed " data-content="sidebarMenu">
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand"><a href="/demo2/index.html" class="logo-link nk-sidebar-logo"><img
                                class="logo-light logo-img" src="home/images/logo.png" srcset="home/images/logo2x.png 2x"
                                alt="logo"><img class="logo-dark logo-img" src="home/images/logo-dark.png"
                                srcset="home/images/logo-dark2x.png 2x" alt="logo-dark"><img
                                class="logo-small logo-img logo-img-small" src="home/images/logo-small.png"
                                srcset="home/images/logo-small2x.png 2x" alt="logo-small"></a></div>
                        ...
                        <div class="nk-sidebar-menu" data-simplebar="">
                            <ul class="nk-menu">
                                <li class="nk-menu-item"><a href="index.html" class="nk-menu-link"><span
                                            ...
                                            <em class="fa-solid fa-chart-line"></em></span> 
    
                                            <span
                                            class="nk-menu-text">Dashboard</span></a></li>
                                <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle">
                                    <span class="nk-menu-icon"><em class="fa-solid fa-note-sticky"></em></span>
                                            <span
                                            class="nk-menu-text">Site Page</span></a>
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li class="nk-menu-item"><a href="courses.html" class="nk-menu-link"><span
                                                    class="nk-menu-text">Contact
                                                    details</span></a></li>
                                        <li class="nk-menu-item"><a href="courses.html" class="nk-menu-link"><span
                                                    class="nk-menu-text">Privacy policy
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="courses.html" class="nk-menu-link"><span
                                                    class="nk-menu-text">Terms &
                                                    Conditions</span></a></li>
                                        <li class="nk-menu-item"><a href="courses.html" class="nk-menu-link"><span
                                                    class="nk-menu-text">Sustainable
                                                    Development Goals</span></a></li>
                                    </ul>
                                </li>
                                <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                                            class="nk-menu-icon"><em class="icon ni ni-user-fill"></em></span><span
                                            class="nk-menu-text">Manage Masters</span></a>
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item"><a href="instructor-dashborad.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Topics
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="instructor-list.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Sub Topic admin
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="instructor-details.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Courses
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="instructor-payment.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Students
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="instructor-payment.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Subscriptions
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="instructor-payment.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Student Subscriptions
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="instructor-payment.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Bulk registrations
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="instructor-payment.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Payments
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="instructor-payment.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Users
                                                </span></a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item"><a href="enroll-history.html"
                                                class="nk-menu-link"><span class="nk-menu-text">MIS
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="enroll-student.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Daily Payment
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="enroll-student.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Daily Payment
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="enroll-student.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Pending Subscriptions
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="enroll-student.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Courses List
                                                </span></a></li>
                                        <li class="nk-menu-item"><a href="enroll-student.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Students List
                                                </span></a></li>
                                    </ul>
                                </li>
                                <li class="nk-menu-item"><a href="message.html" class="nk-menu-link"><span
                                            ...
                                            class="nk-menu-text">Blog</span></a></li>
                                <li class="nk-menu-item"><a href="message.html" class="nk-menu-link"><span
                                            class="nk-menu-icon"><em class="icon ni ni-chat-fill"></em></span><span
                                            class="nk-menu-text">Free resources</span></a></li>
                                <li class="nk-menu-item"><a href="message.html" class="nk-menu-link"><span
                                            class="nk-menu-icon"><em class="icon ni ni-chat-fill"></em></span><span
                                            class="nk-menu-text">Affiliate</span></a></li>
                                <li class="nk-menu-item"><a href="message.html" class="nk-menu-link"><span
                                            class="nk-menu-icon"><em class="icon ni ni-chat-fill"></em></span><span
                                            class="nk-menu-text">Career</span></a></li>
                                <li class="nk-menu-item"><a href="message.html" class="nk-menu-link"><span
                                            class="nk-menu-icon"><em class="icon ni ni-chat-fill"></em></span><span
                                            class="nk-menu-text">Corporate Governance</span></a></li>
                                <li class="nk-menu-item"><a href="message.html" class="nk-menu-link"><span
                                            class="nk-menu-icon"><em class="icon ni ni-chat-fill"></em></span><span
                                            class="nk-menu-text">Forgot Password</span></a></li>
                                <li class="nk-menu-item"><a href="message.html" class="nk-menu-link"><span
                                            class="nk-menu-icon"><em class="icon ni ni-chat-fill"></em></span><span
                                            class="nk-menu-text">Change Password</span></a></li>
                    ...
                    <div class="container-fluid">
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-brand d-xl-none"><a href="/demo2/index.html" class="logo-link"><img
                                        class="logo-light logo-img" src="home/images/logo.png"
                                        srcset="home/images/logo2x.png 2x" alt="logo"><img class="logo-dark logo-img"
                                        src="home/images/logo-dark.png" srcset="home/images/logo-dark2x.png 2x"
                                        alt="logo-dark"></a></div>
                                ...
                                <ul class="nk-quick-nav">
                                    <li class="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#"
                                            ...
                                            <div class="quick-icon border border-light"><img class="icon"
                                                    src="home/images/flags/english-sq.png" alt=""></div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                                            <ul class="language-list">
                                                <li><a href="#" class="language-item"><img
                                                            src="home/images/flags/english.png" alt=""
                                                            class="language-flag"><span
                                                            class="language-name">English</span></a></li>
                                                <li><a href="#" class="language-item"><img
                                                            src="home/images/flags/spanish.png" alt=""
                                                            class="language-flag"><span
                                                            class="language-name">Español</span></a></li>
                                                <li><a href="#" class="language-item"><img
                                                            src="home/images/flags/french.png" alt=""
                                                            class="language-flag"><span
                                                            class="language-name">Français</span></a></li>
                                                <li><a href="#" class="language-item"><img
                                                            src="home/images/flags/turkey.png" alt=""
                                                            class="language-flag"><span
                                                ...
                                                <ul class="chat-list">
                                                    ...
                                                    <li class="chat-item"><a class="chat-link" href="message.html">
                                                            <div class="chat-media user-avatar"><img
                                                                    src="home/images/avatar/b-sm.jpg" alt=""></div>
                                                            <div class="chat-info">
                                                                <div class="chat-from">
                                                    ...
                                                    <li class="chat-item"><a class="chat-link" href="message.html">
                                                            <div class="chat-media user-avatar user-avatar-multiple">
                                                                <div class="user-avatar"><img
                                                                        src="home/images/avatar/c-sm.jpg" alt=""></div>
                                                    ...
                                                    <li class="chat-item"><a class="chat-link" href="message.html">
                                                            <div class="chat-media user-avatar"><img
                                                                    src="home/images/avatar/a-sm.jpg" alt=""><span
                                            ...
                                            <div class="card h-100">
                                                ...
                                                <ul class="nk-support">
                                                    <li class="nk-support-item">
                                                        <div class="user-avatar"><img src="home/images/avatar/a-sm.jpg"
                                                                alt=""></div>
                                                    ...
                                                    <li class="nk-support-item">
                                                        <div class="user-avatar"><img src="home/images/avatar/b-sm.jpg"
                                                                alt=""></div>
                                                        <div class="nk-support-content">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <div class="nk-country-region">
                        <ul class="country-list text-center gy-2">
                            <li><a href="#" class="country-item"><img src="home/images/flags/arg.png" alt=""
                                        class="country-flag"><span class="country-name">Argentina</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/aus.png" alt=""
                                        class="country-flag"><span class="country-name">Australia</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/bangladesh.png" alt=""
                                        class="country-flag"><span class="country-name">Bangladesh</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/canada.png" alt=""
                                        class="country-flag"><span class="country-name">Canada
                                        <small>(English)</small></span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/china.png" alt=""
                            ...
                            <li><a href="#" class="country-item"><img src="home/images/flags/french.png" alt=""
                                        class="country-flag"><span class="country-name">France</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/germany.png" alt=""
                                        class="country-flag"><span class="country-name">Germany</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/iran.png" alt=""
                                        class="country-flag"><span class="country-name">Iran</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/italy.png" alt=""
                                        class="country-flag"><span class="country-name">Italy</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/mexico.png" alt=""
                                        class="country-flag"><span class="country-name">México</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/philipine.png" alt=""
                                        class="country-flag"><span class="country-name">Philippines</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/portugal.png" alt=""
                                        class="country-flag"><span class="country-name">Portugal</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/s-africa.png" alt=""
                                        class="country-flag"><span class="country-name">South Africa</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/spanish.png" alt=""
                                        class="country-flag"><span class="country-name">Spain</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/switzerland.png" alt=""
                                        class="country-flag"><span class="country-name">Switzerland</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/uk.png" alt=""
                                        class="country-flag"><span class="country-name">United Kingdom</span></a></li>
                            <li><a href="#" class="country-item"><img src="home/images/flags/english.png" alt=""
        ...
        <div class="nk-demo-list" data-simplebar="">
            <div class="nk-demo-item"><a href="https://dashlite.net/demo1/index.html">
                    <div class="nk-demo-image bg-blue"><img class="bg-purple" src="images/landing/layout-1d.jpg"
                            srcset="images/landing/layout-1d2x.jpg 2x" alt="Demo Layout 1"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo2/index.html">
                    <div class="nk-demo-image bg-purple"><img src="images/landing/layout-2d.jpg"
                            srcset="images/landing/layout-2d2x.jpg 2x" alt="Demo Layout 2"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo3/index.html">
                    <div class="nk-demo-image bg-success"><img src="images/landing/layout-3d.jpg"
                            srcset="images/landing/layout-3d2x.jpg 2x" alt="Demo Layout 3"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo4/index.html">
                    <div class="nk-demo-image bg-indigo"><img src="images/landing/layout-4d.jpg"
                            srcset="images/landing/layout-4d2x.jpg 2x" alt="Demo Layout 4"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo5/index.html">
                    <div class="nk-demo-image bg-orange"><img src="images/landing/layout-5d.jpg"
                            srcset="images/landing/layout-5d2x.jpg 2x" alt="Demo Layout 5"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo6/index.html">
                    <div class="nk-demo-image bg-purple"><img src="images/landing/layout-6d.jpg"
                            srcset="images/landing/layout-6d2x.jpg 2x" alt="Demo Layout 6"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo7/index.html">
                    <div class="nk-demo-image bg-teal"><img src="images/landing/layout-7d.jpg"
                            srcset="images/landing/layout-7d2x.jpg 2x" alt="Demo Layout 7"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo8/index.html">
                    <div class="nk-demo-image bg-azure"><img src="images/landing/layout-8d.jpg"
                            srcset="images/landing/layout-8d2x.jpg 2x" alt="Demo Layout 8"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo9/index.html">
                    <div class="nk-demo-image bg-pink"><img src="images/landing/layout-9d.jpg"
                            srcset="images/landing/layout-9d2x.jpg 2x" alt="Demo Layout 9"></div><span
                        class="nk-demo-title"><strong>Demo Layout 9</strong></span>
                </a></div>
            <div class="nk-demo-item"><a href="https://dashlite.net/landing/index.html">
                    <div class="nk-demo-image bg-red"><img src="images/landing/main-landing.jpg"
                            srcset="images/landing/main-landing2x.jpg 2x" alt="Landing Page"></div><span
        ...
        <div class="nk-demo-list" data-simplebar="">
            <div class="nk-demo-item"><a href="https://dashlite.net/demo9/copywriter/index.html">
                    <div class="nk-demo-image bg-indigo"><img src="images/landing/demo-ai-copywriter.jpg"
                            srcset="images/landing/demo-ai-copywriter2x.jpg 2x" alt="ai-copywriter"></div><span
                        class="nk-demo-title"><em class="text-primary">Demo9</em><br><strong>Ai Copywriter
                            Panel</strong></span>
                </a></div>
            <div class="nk-demo-item"><a href="https://dashlite.net/demo7/pharmacy/index.html">
                    <div class="nk-demo-image bg-warning"><img src="images/landing/demo-pharmacy.jpg"
                            srcset="images/landing/demo-pharmacy2x.jpg 2x" alt="pharmacy"></div><span
                        class="nk-demo-title"><em class="text-primary">Demo7</em><br><strong>Pharmacy Management
                            Panel</strong></span>
                </a></div>
            <div class="nk-demo-item"><a href="https://dashlite.net/demo5/loan/index.html">
                    <div class="nk-demo-image bg-purple"><img src="images/landing/demo-loan.jpg"
                            srcset="images/landing/demo-loan2x.jpg 2x" alt="loan"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo2/ecommerce/index.html">
                    <div class="nk-demo-image bg-dark"><img src="images/landing/demo-ecommerce.jpg"
                            srcset="images/landing/demo-ecommerce2x.jpg 2x" alt="Ecommerce"></div><span
            ...
            <div class="nk-demo-item"><a href="index.html">
                    <div class="nk-demo-image bg-danger"><img src="images/landing/demo-lms.jpg"
                            srcset="images/landing/demo-lms2x.jpg 2x" alt="LMS"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo1/crm/index.html">
                    <div class="nk-demo-image bg-info"><img src="images/landing/demo-crm.jpg"
                            srcset="images/landing/demo-crm2x.jpg 2x" alt="CRM / Customer Relationship"></div>
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo7/hospital/index.html">
                    <div class="nk-demo-image bg-indigo"><img src="images/landing/demo-hospital.jpg"
                            srcset="images/landing/demo-hospital2x.jpg 2x" alt="Hospital Managemen"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo1/hotel/index.html">
                    <div class="nk-demo-image bg-pink"><img src="images/landing/demo-hotel.jpg"
                            srcset="images/landing/demo-hotel2x.jpg 2x" alt="Hotel Managemen"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo3/cms/index.html">
                    <div class="nk-demo-image bg-dark"><img src="images/landing/demo-cms.jpg"
                            srcset="images/landing/demo-cms2x.jpg 2x" alt="cms"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo5/crypto/index.html">
                    <div class="nk-demo-image bg-warning"><img src="images/landing/demo-buysell.jpg"
                            srcset="images/landing/demo-buysell2x.jpg 2x" alt="Crypto BuySell / Wallet"></div>
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo6/invest/index.html">
                    <div class="nk-demo-image bg-indigo"><img src="images/landing/demo-invest.jpg"
                            srcset="images/landing/demo-invest2x.jpg 2x" alt="HYIP / Investment"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo3/apps/file-manager.html">
                    <div class="nk-demo-image bg-purple"><img src="images/landing/demo-file-manager.jpg"
                            srcset="images/landing/demo-file-manager2x.jpg 2x" alt="File Manager"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo4/subscription/index.html">
                    <div class="nk-demo-image bg-primary"><img src="images/landing/demo-subscription.jpg"
                            srcset="images/landing/demo-subscription2x.jpg 2x" alt="SAAS / Subscription"></div>
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/covid/index.html">
                    <div class="nk-demo-image bg-danger"><img src="images/landing/demo-covid19.jpg"
                            srcset="images/landing/demo-covid192x.jpg 2x" alt="Covid Situation"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo3/apps/messages.html">
                    <div class="nk-demo-image bg-success"><img src="images/landing/demo-messages.jpg"
                            srcset="images/landing/demo-messages2x.jpg 2x" alt="Messages"></div><span
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo3/apps/mailbox.html">
                    <div class="nk-demo-image bg-purple"><img src="images/landing/demo-inbox.jpg"
                            srcset="images/landing/demo-inbox2x.jpg 2x" alt="Inbox"></div><span
                        class="nk-demo-title"><em class="text-primary">Demo3</em><br><strong>Apps -
                            Mailbox</strong></span>
                </a></div>
            <div class="nk-demo-item"><a href="https://dashlite.net/demo3/apps/chats.html">
                    <div class="nk-demo-image bg-purple"><img src="images/landing/demo-chats.jpg"
                            srcset="images/landing/demo-chats2x.jpg 2x" alt="Chats / Messenger"></div><span
                        class="nk-demo-title"><em class="text-primary">Demo3</em><br><strong>Apps -
                            Chats</strong></span>
                </a></div>
        </div>
